Public Class ShortcutManager
            ...
            Else
                If GridView1.DataRowCount > 0 Then
                    For i = 0 To GridView1.DataRowCount - 1
                        If LookUpEdit1.EditValue.Trim = DirectCast(GridView1.GetDataRow(i), WinImpExp.NewDBFDataSet.orgshortRow).code.Trim Then
                ...
                OrgshortTableAdapter.InsertShort(TextEdit1.EditValue, LookUpEdit1.EditValue)
    ...
    Private Sub SimpleButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton2.Click
        Try
            ...
            OrgshortTableAdapter.Delete1(GridView1.GetFocusedDataRow("firstcode").ToString, GridView1.GetFocusedDataRow("code").ToString)
            Me.OrgshortTableAdapter.Fill(Me.NewDBFDataSet.orgshort)
            GridView1.RefreshData()
        Catch ex As Exception
            Dim trace As New System.Diagnostics.StackTrace(ex, True)
    ...
    Private Sub ShortcutManager_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
