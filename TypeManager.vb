Public Class TypeManager
    ...
    Private Sub SimpleButton4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton4.Click
        Try
            ...
            Select Case OPType
                Case "ADD"
                    orgno = TypeTableAdapter.GetNextNo().ToString
                    ...
                    Else
                        If GridView1.DataRowCount > 0 Then
                            For i = 0 To GridView1.DataRowCount - 1
                                If TextEdit1.Text.Trim = DirectCast(GridView1.GetDataRow(i), WinImpExp.NewDBFDataSet.TypeRow).Type.Trim Then
                        ...
                        TypeTableAdapter.Insert(orgno, TextEdit1.EditValue)
                ...
                Case "EDIT"
                    ...
                    Else
                        For i = 0 To GridView1.DataRowCount - 1
                            ...
                            End If
                        Next
                        TypeTableAdapter.Update(TextEdit1.EditValue, GridView1.GetFocusedDataRow("Type_Code").ToString, GridView1.GetFocusedDataRow("Type").ToString)
    ...
    Private Sub SimpleButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton2.Click
        Try
            ...
            TypeTableAdapter.Delete(GridView1.GetFocusedDataRow("Type_Code").ToString, GridView1.GetFocusedDataRow("Type").ToString)
            Me.TypeTableAdapter.Fill(Me.NewDBFDataSet.Type)
            GridView1.RefreshData()
        Catch ex As Exception
            Dim trace As New System.Diagnostics.StackTrace(ex, True)
    ...
    Private Sub TypeManager_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
