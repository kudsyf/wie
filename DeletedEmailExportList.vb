Public Class DeletedEmailExportList

    Private Sub DeletedEmailExportList_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'NewDBFDataSet.EmailExports' table. You can move, or remove it, as needed.

        Try
            Me.EmailExportsTableAdapter.FillByDeleted(Me.NewDBFDataSet.EmailExports, CurOrgNo)
