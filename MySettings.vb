Public Class MySettings
    ...
    Public Shared Function GetSetting(ByVal Key As String) As String
        ...
        If System.IO.File.Exists(Application.StartupPath & "\AppSettings.xml") Then
            dsSettings.ReadXml(Application.StartupPath & "\AppSettings.xml")
        Else
    ...
    Public Shared Sub SetSetting(ByVal Key As String, ByVal Value As String)
        ...
        End If
        dsSettings.WriteXml(Application.StartupPath & "\AppSettings.xml")
    End Sub
End Class
